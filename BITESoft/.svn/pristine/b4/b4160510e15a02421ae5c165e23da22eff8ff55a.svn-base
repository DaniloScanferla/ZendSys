...
class User extends \User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'User\\Entity\\User' . "\0" . 'id', '' . "\0" . 'User\\Entity\\User' . "\0" . 'nome', '' . "\0" . 'User\\Entity\\User' . "\0" . 'email', '' . "\0" . 'User\\Entity\\User' . "\0" . 'password', 'role', '' . "\0" . 'User\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'User\\Entity\\User' . "\0" . 'active', '' . "\0" . 'User\\Entity\\User' . "\0" . 'activationKey', '' . "\0" . 'User\\Entity\\User' . "\0" . 'createdAt', '' . "\0" . 'User\\Entity\\User' . "\0" . 'updatedAt');
        }

 ...
 */
class Fornecedor extends \Produto\Entity\Fornecedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'descricao', 'apelido', 'cnpj', 'endereco', '' . "\0" . 'Produto\\Entity\\Fornecedor' . "\0" . 'ativo', 'createdAt', 'updatedAt');
        }
